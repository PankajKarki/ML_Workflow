...
def evaluate_model(config_path: Text) -> None:
    ...
    models_folder = config['model']['model_path']

    pathlib.Path(config['evaluate']['reports_folder']).mkdir(parents=True, exist_ok=True)
    reports_folder = config['evaluate']['reports_folder']
